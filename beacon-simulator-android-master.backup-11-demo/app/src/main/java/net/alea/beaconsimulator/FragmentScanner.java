...
public class FragmentScanner extends Fragment {
    ...
    private static final int SWICH_REFRESH_DELAY = 1000; // in ms
...
*/
    ...
    public class ScannedBeaconAdapter extends RecyclerView.Adapter<ScannedBeaconAdapter.ViewHolder> {
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            holder.mac.setText(String.format("Neighbour ID: %8s",Long.toString(scanResult.getSocialEmp())));
            ...
            holder.rssi.setText(String.format("%4s",df.format(distance)));
            ...
            String typeMessage = String.format("Proximity duration HH:MM: %2s:%2s", Long.toString(hours), Long.toString(minutes) );
            String subTypeMessage = String.format("Last contact time: %s", scanResult.getExitTime().toString());
        ...
        public void addScanResult() {
            ...
            for (String id: beaconId) {
                ...
                if (_beaconPositions.containsKey(id)) {
                    int pos = _beaconPositions.get(id);
                        _dataset.set(pos, sm);
