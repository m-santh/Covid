...
public class FragmentSettings extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        switch (key) {
            ...
            case Config.PREF_KEY_EMPNO: {
		        String empno = sharedPreferences.getString(Config.PREF_KEY_EMPNO, "00000000");

                empno = String.format("%8s", empno).replace(' ', '0');
		        if(empno.equals("00000000") || empno.length() > 8 ) {
		            //: Fore activity..
