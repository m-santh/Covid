...
*/
    ...
    public class ScannedBeaconAdapter extends RecyclerView.Adapter<ScannedBeaconAdapter.ViewHolder> {
        ...
        public class ViewHolder extends RecyclerView.ViewHolder {
            ...
            public final TextView lastknown;
            ...
            public ViewHolder(View v) {
                ...
                lastknown =(TextView) v.findViewById(R.id.scannedbeacon_last_rssi);
        ...
        public void onBindViewHolder(ViewHolder holder, int position) {
            ...
            if(mShowCurrent) {
                ...
                holder.rssi.setTextColor(Color.parseColor("#000000"));
                holder.beaconType.setImageResource(R.drawable.ic_social_distance_grey);
            }
            /*
            ...
            Spanned typeMessage = Html.fromHtml(String.format("Duration Time (HH:MM:SS) <b>%s</b>", time)); //Long.toString(hours), Long.toString(minutes) ));
            Spanned subTypeMessage; //= Html.fromHtml(String.format("Last Update <b>%s</b>", "<font color='red'>" + date + "</font>"));
            if(visibleTime < BeaconScannerService.ANDROID_N_MIN_SCAN_CYCLE_MILLIS ) { //(SWICH_REFRESH_DELAY + BeaconScannerService.DELTA_TIME_MILLIS)) {
                ...
                holder.lastknown.setVisibility(View.GONE);
            }
            else {
                subTypeMessage = Html.fromHtml(String.format("Last Update <b>%s</b>", date ));
                holder.lastknown.setVisibility(View.VISIBLE);
            }
        ...
        public void startTimer() {
            ...
            timer.schedule(timerTask, SWICH_REFRESH_DELAY); //
        }
