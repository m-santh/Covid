...
public class SocialBeaconModel extends  BeaconModel implements Parcelable {
    ...
    private static final long SCAN_EXIT_TIME_MILLIS = 5 * 60 * 1000;
    ...
    public void updateRssi(int rssi) {
        ...
        if(duration > SCAN_EXIT_TIME_MILLIS) {
            this.entryTime = getCurrentTimestamp();
        }
        ...
        if(this.rssi == 0) {
            ...
            this.rssi = (this.rssi + rssi)/2; // moving average
        }

        this.distance = calculateDistance(getIBeacon().getPower(), rssi);
    }
