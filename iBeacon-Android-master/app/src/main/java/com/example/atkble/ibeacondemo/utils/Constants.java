...
package com.example.atkble.ibeacondemo.utils;
...
public final class Constants {
    ...
    public static final String TAG = "AtkinsBubble";
    ...
    public static final String REGION_NAME_PREFIX = "com.example.atkble.ibeacondemo";
    //actions
    public static final String NOTIFY_BEACON_ENTERS_REGION = "com.example.atkble.ibeacondemo.action.NOTIFY_BEACON_ENTERS_REGION";
    public static final String NOTIFY_BEACON_LEAVES_REGION = "com.example.atkble.ibeacondemo.action.NOTIFY_BEACON_LEAVES_REGION";
    public static final String NOTIFY_BEACON_NEAR_YOU_REGION = "com.example.atkble.ibeacondemo.action.NOTIFY_BEACON_NEAR_YOU_REGION";

    public static final String ALARM_NOTIFICATION_SHOW = "com.example.atkble.ibeacondemo.action.ALARM_NOTIFICATION_SHOW";
    public static final String GET_CURRENT_LOCATION = "com.example.atkble.ibeacondemo.action.GET_CURRENT_LOCATION";
